...
class ServerStorage:
    ...
    def __init__(self):
        ...
        users_table = Table('Users', self.reg_map.metadata,
        ...
        active_users_table = Table('Active_users', self.reg_map.metadata,
                                   Column('id', Integer, primary_key=True),
        ...
        user_login_history = Table('Login_history', self.reg_map.metadata,
                                   Column('id', Integer, primary_key=True),
        ...
        self.reg_map.map_imperatively(self.AllUsers, users_table)
        self.reg_map.map_imperatively(self.ActiveUsers, active_users_table)
        self.reg_map.map_imperatively(self.LoginHistory, user_login_history)
        # Создаём сессию
